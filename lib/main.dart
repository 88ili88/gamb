...
import 'package\:flutter\_reactive\_ble/flutter\_reactive\_ble.dart';
...
final header = ListToCsvConverter().convert(\[
...
final csvLine = ListToCsvConverter().convert([sample.toCsvRow()]);
...
'EC=\${s.ec.toStringAsFixed(1)} mS/cm, T=\${s.temp.toStringAsFixed(1)}°C, ' +
'S=\${s.sal.toStringAsFixed(1)} g/L, B=\${s.batt.toStringAsFixed(2)} V'),
);
},
),
),
